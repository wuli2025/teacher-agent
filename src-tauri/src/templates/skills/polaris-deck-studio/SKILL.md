...
顶层三个键：`version` 恒为 `1`；`theme` 取下面 7 套色板之一；`slides` 是页数组，**最多 300 页**，不能为空。
...
| `midnight-gold` | 深蓝黑渐变 + 香槟金（深色） | 评审汇报/发布会/报告拆解,「高级感」首选 |
...
#### 叙事骨架（观感「高级」的第一来源，≥8 页时是硬要求）

`title` 封面 → **目录页** → （`section` 章节页 → 该章内容页…）× N → `closing` 结尾。

- **封面**：汇报/讲座/报告拆解类优先深色板（`midnight-gold` 首选，其次 `ink-gold`/`deep-space`）；封面与各 `section` 页加 `"transition": {"type": "fade"}`，其余页不加——节奏统一才显贵，页页换花样显乱。
- **目录页必须有**（≤6 页的小 deck 可省）：用 `freeform` 摆「01/02/03/04」编号卡网格——大编号用 accent 色，一章一卡：编号 + 章名 + 一句概括。章数不是 4 时增删卡并按同一网格重摆。四章版直接抄改：

```json
{"layout": "freeform", "notes": "先总览全篇结构再进入正文", "boxes": [
  {"type": "text", "x": 80,  "y": 52,  "w": 400, "h": 56, "text": "目录", "size": 34, "bold": true, "color": "ink"},
  {"type": "rect", "x": 82,  "y": 118, "w": 56,  "h": 4,  "color": "accent"},
  {"type": "card", "x": 80,  "y": 168, "w": 546, "h": 222},
  {"type": "text", "x": 112, "y": 196, "w": 140, "h": 52, "text": "01", "size": 30, "bold": true, "color": "accent"},
  {"type": "text", "x": 112, "y": 258, "w": 482, "h": 36, "text": "第一章标题", "size": 20, "bold": true, "color": "ink"},
  {"type": "text", "x": 112, "y": 302, "w": 482, "h": 64, "lines": ["一句话概括本章讲什么"], "size": 13, "color": "muted"},
  {"type": "card", "x": 654, "y": 168, "w": 546, "h": 222},
  {"type": "text", "x": 686, "y": 196, "w": 140, "h": 52, "text": "02", "size": 30, "bold": true, "color": "accent"},
  {"type": "text", "x": 686, "y": 258, "w": 482, "h": 36, "text": "第二章标题", "size": 20, "bold": true, "color": "ink"},
  {"type": "text", "x": 686, "y": 302, "w": 482, "h": 64, "lines": ["一句话概括本章讲什么"], "size": 13, "color": "muted"},
  {"type": "card", "x": 80,  "y": 418, "w": 546, "h": 222},
  {"type": "text", "x": 112, "y": 446, "w": 140, "h": 52, "text": "03", "size": 30, "bold": true, "color": "accent"},
  {"type": "text", "x": 112, "y": 508, "w": 482, "h": 36, "text": "第三章标题", "size": 20, "bold": true, "color": "ink"},
  {"type": "text", "x": 112, "y": 552, "w": 482, "h": 64, "lines": ["一句话概括本章讲什么"], "size": 13, "color": "muted"},
  {"type": "card", "x": 654, "y": 418, "w": 546, "h": 222},
  {"type": "text", "x": 686, "y": 446, "w": 140, "h": 52, "text": "04", "size": 30, "bold": true, "color": "accent"},
  {"type": "text", "x": 686, "y": 508, "w": 482, "h": 36, "text": "第四章标题", "size": 20, "bold": true, "color": "ink"},
  {"type": "text", "x": 686, "y": 552, "w": 482, "h": 64, "lines": ["一句话概括本章讲什么"], "size": 13, "color": "muted"}
]}
```

- **章节页与目录呼应**：每个 `section` 的 `kicker` 写对应编号（如 `"kicker": "01"`），观众随时知道讲到哪。
